...
def calib_ext(cam):
    ...
    if(SETUP == True):
        ...
        stp.IMG_EXTRINSIC_CALIB = stp.switch_calib_img_path(cam, type='ext')
        stp.INTRINSIC_CALIB_DATA = stp.switch_calib_data_path(cam, type='int')
        stp.EXTRINSIC_CALIB_DATA = stp.switch_calib_data_path(cam, type='ext')
        ...
        np.savez(stp.EXTRINSIC_CALIB_DATA, P=P, R=R, Rt=Rt, r_vector=r_vector, t_vector=t_vector)
...
if(__name__ == "__main__"):
    ...
    for cam in stp.CAMS:
        ...
        try:
            (camera_mtx, dist_coeff) = calib_int(cam)
        
        except Exception as e:

            print("#======================================================================#")
            print(f"\t\tERROR INTRINSIC CALIBRATION")
            print(f"{e}")
            print("#======================================================================#")
        ...
        try :
            ...
            print("#======================================================================#")
            print(f"\t\tERROR EXTRINSIC CALIBRATION")
            print(f"{e}")
            print("#======================================================================#")
